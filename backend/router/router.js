...
import { RCDetailsApiController,rc_fail_data_remove ,rc_fail_data_store,rc_remind_me_remove } from '../controller/api/RCDetailsApiController.js';
...
router.post('/user_vehicle_search',decryptObject, ResaleValue.getUserVehicleSearch)
...
router.post("/vasu_news_category", decryptObject, NewsApiController.newsCategory)
...
// router.post("/feedback",decryptObject,Feedback.feedback)
...
router.post("/user_vehicle_document_upload" ,decryptObject,DocumentController.userDocumentUpload)//document uploaded successFully
router.post("/user_vehicle_document_delete" ,DocumentController.userDocumentDelete) //document deleted SuccessFully
router.post("/user_vehicle_document_edit" ,DocumentController.userDocumentEdit) //document edit successFully
router.post("/user_vehicle_document_delete_by_number",DocumentController.userDocumentDeleteByNumber) // testing done
router.post("/user_searched_number_remove",DocumentController.userSearchedNumberRemove) // issue for vehicle information  all vehicle Inforamation details in previous
router.post("/user_searched_number_store",DocumentController.userSearchedByNumberStore) // pending
router.post("/vasu_user_record_delete",DocumentController.deleteUserRecord) //testing done
router.post("/user_subscription",DocumentController.useSubscription) // done but testing pending and purchase time differnt date show
...
/************* Rc Details Nirmal 01-11-2023 *****/
router.post("/rc_fail_data_remove", decryptObject, rc_fail_data_remove )
router.post("/rc_fail_data_store",decryptObject,rc_fail_data_store)
router.post("/rc_remind_me_remove",decryptObject,rc_remind_me_remove)
