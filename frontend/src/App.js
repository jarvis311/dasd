...
import DrivingSchoolInfoState from './pages/Driving School State/DrivingSchoolInfoState.jsx';
...
import QuoraAds from './pages/QuoraAds/QuoraAds';
import QuoraAdsAdd from './pages/QuoraAds/QuoraAdsAdd';
import QuoraAdsView from './pages/QuoraAds/QuoraAdsView';
...
function App() {
    ...
    return (
        <>
            <AuthContext.Provider value={{ classActive, setClassActive }}>
                ...
                <BrowserRouter>
                    <Routes>
                        ...
                        <Route element={<PrivetRoutes />}>
                            ...
                            {/* Change by jignesh 02-11-'23 */}
                            <Route path="/driving" element={<Driving_School_state />} />
                            <Route path="/view/driving/:id" element={<View_Driving_school_state />} />
                            <Route path="/add/driving" element={<DrivingSchoolInfoState />} />
                            <Route path="/edit/driving/:id" element={<DrivingSchoolInfoState />} />

                            <Route path="/driving_city" element={<Driving_School_city />} />
                            <Route path="/add/driving_city" element={<Edit_Driving_school_city />} />
                            ...
                            <Route path="/add/driving_area" element={<Edit_Driving_school_Area />} />
                            ...
                            <Route path="/add/driving_detail" element={<Edit_Driving_school_Detail />} />
                            ...
                            {/* Change by jignesh end */}
                            <Route path="/service_state" element={<Service_state />} />
                            <Route path="/add/service_state" element={<Edit_service_state />} />
                            ...
                            <Route path="/add/service_city" element={<Edit_service_center_city />} />
                            ...
                            <Route path="/Add/service_brand" element={< Edit_service_center_brand />} />
                            ...
                            <Route path="/Add/service_center" element={<Edit_service_center />} />
                            ...
                            <Route path="/Add/service_Dealer" element={<Edit_service_Dealer />} />
                            ...
                            <Route path="affiliationcity" element={<AffiliationCity />} />
                            <Route path="affiliationcity/add" element={<AffiliationCityAdd />} />
                            <Route path="affiliationcity/view" element={<AffiliationCityView />} />

                            <Route path="serviceprovidercity" element={<ServiceProviderCity />} />
                            <Route path="serviceprovidercity/add" element={<ServiceProviderCityAdd />} />
                            <Route path="serviceprovidercity/view" element={<ServiceProviderCityView />} />

                            <Route path="quoraads" element={<QuoraAds />} />
                            <Route path="quoraads/add" element={<QuoraAdsAdd />} />
                            <Route path="quoraads/view" element={<QuoraAdsView />} />
