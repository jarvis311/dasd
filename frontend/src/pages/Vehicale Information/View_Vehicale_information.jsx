...
const View_Vehicale_information = () => {
  ...
  const Dropdown_Name = async () => {
    ...
    Result.data.data.map((val, i) => {
      DropDownArr.push({ label: val.model_name, value: val._id })
  ...
  const Getview = async (Eid) => {
    ...
    SetData({
      ...
      launched_date: dayjs(result.data.Launch_date).format("DD-MM-YYYY"),
    ...
    <Layout sidebar={true}>
      <div className="page-heading">
        ...
        <div className="page-heading-right">
          <SelectPicker data={DropDropValue} defaultValue={id._id} cleanable={false} className="wv-200 my-1 ms-3" onChange={(e) => selectpickerData(e)} placeholder="Select Category" placement="bottomEnd" />
        ...
        <Card>
          <Card.Body>
            <Row>
              ...
              <Col md={4}>
                <div className='mb-4'>
                  <p className='mb-0 fw-bold'>Is Designer</p><span>{Data.is_designer == 1 ? "Open" : "Close"}</span>
                </div>
              </Col>
              <Col md={4}>
                <div className='mb-4'>
                  <p className='mb-0 fw-bold'>Is content writer</p><span>{Data.is_content_writer == 1 ? "Open" : "Close"}</span>
                </div>
              </Col>
            </Row>
          </Card.Body>
