          ...
          <Card className="mb-4">
            <Card.Body>
              <Row>
                ...
                <Col md={3}>
                  <Form.Label htmlFor="miniumprice">Minimum Price</Form.Label>
                  <Form.Control
                    type="number"
                    className="my-2"
                    name="min_price"
                ...
                <Col md={2}>
                  <Form.Label htmlFor="contentwriterupdated" className="d-block mb-2">
                ...
                <Col md={2}>
                  <Form.Label htmlFor="designerupdated" className="d-block mb-2">
                    Designer Updated
                  </Form.Label>
                  <Switch
                ...
                {ShowVariant == true &&
                  Variant_Price.map((detail, i) => (
                    <Row>
                      ...
                      <Col md={3}>
                        <Form.Label htmlFor="exshowromprice">Ex Show Room Price </Form.Label>
                        <Form.Control
                          type="number"
                          className="my-2"
