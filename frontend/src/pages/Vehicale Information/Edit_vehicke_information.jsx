...
const Edit_vehicke_information = () => {
  ...
  const DesignerHendler = (e) => {
    ...
    setData({
      ...
      latest: Data.latest,
      is_designer: Result,
      is_content_writer: Data.is_content_writer,
      manu_des: Data.manu_des,
      price_des: Data.price_des,
      high_des: Data.high_des,
      key_specs: Data.key_specs,
  ...
  const Getview = async (Eid) => {
    ...
    console.log('result=====>>>>', result.data.is_designer)
    setData({
      _id: result.data._id,
      ...
      review: result.data.review_count,
      ...
      launched_date: dayjs(result.data.Launch_date).format("YYYY-MM-DD"),
      popularity: result.data.model_popularity,
      mileage: result.data.mileage,
      engine: result.data.engine,
      max_power: result.data.max_power,
      showroom_price: result.data.showroom_price,
      road_price: result.data.on_road_price,
      rto_price: result.data.rto_price,
      insurance_price: result.data.insurance_price,
      other_price: result.data.other_price,
      upcoming: result.data.is_upcoming,
      latest: result.data.is_latest,
      is_designer: result.data.is_designer,
      is_content_writer: result.data.is_content_writer,
      manu_des: result.data.manufaturer_desc,
      price_des: result.data.price_desc,
      high_des: result.data.highlights_desc,
    ...
    if (Data.name == undefined || Data.fuel_type == undefined || Data.rating == undefined || Data.review == undefined || Data.min_price == undefined ||
      ...
      if (count !== 0) {
        ...
        if (count1 !== 0) {
          ...
          Form.append("is_content_writer", Update)
          Form.append("is_designer", DesUpdate)
          ...
          <Card className="mb-4">
            <Card.Body>
              <Row>
                ...
                <Col md={3}>
                  <Form.Label htmlFor="bodytype">Body Type</Form.Label>
                  <SelectPicker
                    cleanable={false}
                ...
                <Col md={3}>
                  <Form.Label htmlFor="modalname">Model Name</Form.Label>
                  <Form.Control
                    type="text"
                    className="my-2"
                    name="name"
                ...
                <Col md={3}>
                  <Form.Label htmlFor="fueltype">Fuel Type</Form.Label>
                  <Form.Control
                    type="text"
                    className="my-2"
                    name="fuel_type"
                ...
                <Col md={3}>
                  <Form.Label htmlFor="avgrating">Avg Rating</Form.Label>
                  <Form.Control
                    type="number"
                    className="my-2"
                    name="rating"
                ...
                <Col md={3}>
                  <Form.Label htmlFor="reviewcount">Review Count</Form.Label>
                  <Form.Control
                    type="number"
                    className="my-2"
                    name="review"
                ...
                <Col md={3}>
                  <Form.Label htmlFor="maximumprice">Maximum Price</Form.Label>
                  {console.log('Data.max_price', Data.max_price)}
                  <Form.Control
                    type="number"
                    className="my-2"
                    name="max_price"
                ...
                <Col md={3}>
                  <Form.Label htmlFor="variantname">Variant Name</Form.Label>
                  <Form.Control
                    type="text"
                    className="my-2"
                    name="varient_name"
                ...
                <Col md={3}>
                  <Form.Label htmlFor="launchedat">Launched At</Form.Label>
                  <Form.Control
                    type="date"
                    className="my-2"
                    name="launched_at"
                ...
                <Col md={3}>
                  <Form.Label htmlFor="launcheddate">Launched Date</Form.Label>
                  <Form.Control
                    type="date"
                    className="my-2"
                    name="launched_date"
                ...
                <Col md={3}>
                  <Form.Label htmlFor="modelpopularity">Model Popularity</Form.Label>
                  <Form.Control
                    type="number"
                    className="my-2"
                    name="popularity"
                ...
                <Col md={3}>
                  <Form.Label htmlFor="maxpower">Max Power</Form.Label>
                  <Form.Control
                    type="number"
                    className="my-2"
                    name="max_power"
                ...
                <Col md={3}>
                  <Form.Label htmlFor="showroomprice">Showroom Price</Form.Label>
                  <Form.Control
                    type="number"
                    className="my-2"
                    name="showroom_price"
                  ...
                  />
                  <Form.Control.Feedback type="invalid">
                    Showroom Price Field Is Require
                  </Form.Control.Feedback>
                </Col>

                <Col md={3}>
                  <Form.Label htmlFor="onroadprice">On Road Price</Form.Label>
                  <Form.Control
                    type="number"
                    className="my-2"
                    name="road_price"
                ...
                <Col md={3}>
                  <Form.Label htmlFor="rtoprice">RTO Price</Form.Label>
                  <Form.Control
                    type="number"
                    className="my-2"
                    name="rto_price"
                ...
                <Col md={3}>
                  <Form.Label htmlFor="insuranceprice">Insurance Price</Form.Label>
                  <Form.Control
                    type="number"
                    className="my-2"
                ...
                <Col md={3}>
                  <Form.Label htmlFor="otherprice">Other Price</Form.Label>
                  <Form.Control
                    type="number"
                    className="my-2"
                    name="other_price"
                ...
                <Col md={2}>
                  <Form.Label htmlFor="isupcoming" className="d-block">
                    Is Upcoming
                  </Form.Label>
                  <Switch
                ...
                <Col md={2}>
                  <Form.Label htmlFor="islatest" className="d-block">
                    Is Latest
                  </Form.Label>
                  <Switch
                ...
                <Col md={2}>
                  <Form.Label htmlFor="contentwriterupdated" className="d-block">
                    Content Writer Updated
                  </Form.Label>
                  <Switch
                    onChange={conntentHendler}
                    name="is_content_writer"
                    checked={Data.is_content_writer === 1 ? true : false}
                    offColor="#C8C8C8"
                    onColor="#0093ed"
                    height={30}
                    width={70}
                ...
                <Col md={2}>
                  <Form.Label htmlFor="designerupdated" className="d-block">
                    Designer Updated
                  </Form.Label>
                  <Switch
                    onChange={DesignerHendler}
                    name="is_designer"
                    checked={Data.is_designer === 1 ? true : false}
                    offColor="#C8C8C8"
                    onColor="#0093ed"
                    height={30}
                    width={70}
                ...
                <Col md={6}>
                  <Form.Label htmlFor="manufacturer">Manufacturer Description</Form.Label>
                  <Form.Control
                    as="textarea" rows={3}
                    className="my-2"
                    name="manu_des"
                ...
                <Col md={6}>
                  <Form.Label htmlFor="pricedescription">Price Description</Form.Label>
                  <Form.Control
                    as="textarea" rows={3}
                    className="my-2"
                    name="price_des"
                ...
                <Col md={6}>
                  <Form.Label htmlFor="highlights">Highlights Description</Form.Label>
                  <Form.Control
                    as="textarea" rows={3}
                    className="my-2"
                    name="high_des"
                ...
                <Col md={6}>
                  <Form.Label htmlFor="keyspecs">Key Specs</Form.Label>
                  <Form.Control
                    as="textarea" rows={3}
                    className="my-2"
                    name="key_specs"
                ...
                </Row>
                {
                  Modal_color_Data.map((detail, i) => (
                    <Row>
                      <Col md={3}>
                        <Form.Label htmlFor="colorname">Color Name</Form.Label>
                        <Form.Control
                          type="text"
                          className="my-2"
                          name="color_name"
                                ...
                                return image._id ?
                                  (
                                    <div className='position-relative'>
                                      <Image className="hv-40 wv-40 rounded-3 ms-2" src={image.Modal_color_image}></Image>
                                      <i className='bx bx-x close-btns' onClick={() => Remove_image(detail._id, image._id)}></i>
                                    </div>
                                  )
                                  : ""
                              })
                ...
                </Row>
                {
                  Variant_Price.map((detail, i) => (
                    <Row>
                      ...
                      <Col md={3} className="d-flex align-self-end mb-2 justify-content-end">
                        <Button
                          variant="danger"
                          className="btn-icon-lg"
                      ...
                      <Col md={3}>
                        <Form.Label htmlFor="exshowroomprice">Ex Show Room Price </Form.Label>
                        <Form.Control
                          type="number"
                          className="my-2"
                      ...
                      <Col md={3}>
                        <Form.Label htmlFor="latestupdate">Latest Update </Form.Label>
                        <Form.Control
                          type="text"
                          className="my-2"
                          name="latest_update"
                      ...
                      <Col md={3}>
                        <Form.Label htmlFor="variantimage">Variant Image</Form.Label>
                        <InputGroup className="my-2">
                          <Form.Control
                            type="file"
                            name="variant_image"
