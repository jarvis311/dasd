...
const View_Fuel_Price = () => {
  ...
  return (
    ...
    <div className="page-heading">
        <h3><Link to="/fuel/price" className='btn btn-primary btn-icon-lg me-3'><i className='bx bxs-left-arrow-alt'></i></Link>View Fuel Price</h3>
        <div className="page-heading-right">
            <SelectPicker data={DropDropValue} defaultValue={id._id} cleanable={false} className="wv-200 my-1 ms-3" onChange={(e) => selectpickerData(e)} placeholder="Select State" placement="bottomEnd" />
