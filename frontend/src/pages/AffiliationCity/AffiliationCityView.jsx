        ...
        <>
            <Layout sidebar={true}>
                <div className="page-heading">
                    <h3><Link to="/affiliationcity" className='btn btn-primary btn-icon-lg me-3'><i className='bx bxs-left-arrow-alt'></i></Link>View Affiliation City </h3>
                    ...
                    <Card>
                        <Card.Body>
                            <Row className="g-4">
                                <Col md={4}>
                                    <div>
                                        <p className='mb-0 fw-bold'>State</p><span>Gujarat</span>
                                    </div>
                                </Col>
                                <Col md={4}>
                                    <div>
                                        <p className='mb-0 fw-bold'>City</p><span>Junagadh</span>
                                    </div>
                                </Col>
                                <Col md={4}>
                                    <div>
